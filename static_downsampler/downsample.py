...
def downsample2_dataset(ds):
    ...
    ds_d2['areacello_bu'] = downsample2_2dvar(ds, 'areacello_bu', 'Q',
                                              op='sum')
    ds_d2['areacello_cu'] = downsample2_2dvar(ds, 'areacello_cu', 'U',
                                              op='sum')
    ds_d2['areacello_cv'] = downsample2_2dvar(ds, 'areacello_cv', 'V',
                                              op='sum')
...
def downsample2_2dvar(ds, variable, pointtype, op='sum',
                      dimvar_map=None):
    ...
    for jj in range(0, ny_d2):
        for ji in range(0, nx_d2):
            ...
            if area_tot == 0:
                ...
                out[jj, ji] = (a00*b00 + a01*b01 +
                               a10*b10 + a11*b11) / area_tot
    return out
...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--static', required=True,
                        help="input static file")
    parser.add_argument('-o', '--output', required=True,
                        help="output d2 static file")
